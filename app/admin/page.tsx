                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="text-center">
                                <div className="text-2xl font-bold text-blue-600">
                                    {stats.questionsByStatus.duplicate}
                                </div>
                        ...
                        <div className="space-y-3">
                            {recentQuestions.length > 0 ? (
                                recentQuestions.map((question) => (
                                    <div key={question.id} className="flex items-center justify-between space-x-4">
                                        <div className="flex-1 min-w-0">
                                            <p className="text-sm font-medium truncate">
                                                {question.departmentName} - {question.courseName}
                                            </p>
                                            <p className="text-xs text-muted-foreground">
                                                {question.semesterName} • {question.examTypeName} • {question.userName}
                                            </p>
                                        </div>
