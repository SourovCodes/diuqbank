...
import { GenericDeleteButton } from "@/app/admin/components/generic-delete-button";
...
export default async function QuestionsPage({
  ...
  const departmentFilter = awaitedSearchParams.department
    ? parseInt(awaitedSearchParams.department)
    : undefined;
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Questions"
        description="Manage questions in the system"
        crumbs={[
