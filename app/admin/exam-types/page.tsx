...
export default async function ExamTypesPage({
    ...
    const result = await getPaginatedExamTypes(page, 10, search, sortBy, sortOrder);
                                ...
                                <Table>
                                    <TableHeader>
                                        <TableRow>
                                            ...
                                            <SortableTableHeader sortKey="requiresSection" className="w-[150px]">
                                                Requires Section
                                            </SortableTableHeader>
                                            <SortableTableHeader sortKey="order" className="w-[120px]">
                                                Display Order
                                            </SortableTableHeader>
                                    ...
                                    <TableBody>
                                        {examTypes.map((examType) => (
                                            <TableRow key={examType.id}>
                                                ...
                                                <TableCell>
                                                    <Badge variant={examType.requiresSection ? "default" : "secondary"}>
                                                        {examType.requiresSection ? "Yes" : "No"}
                                                    </Badge>
                                                </TableCell>
                                                <TableCell>
