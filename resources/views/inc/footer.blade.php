<section class="hideInApp py-6 bg-white dark:bg-black border-t border-gray-200  dark:border-gray-800   mt-auto sm:pt-10">
        ...
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                ...
                <p class="text-base leading-relaxed text-gray-700 dark:text-gray-400 mt-7">
                    Help Build a Comprehensive Resource for Students of Daffodil International University. Upload
                    Missing Questions or Enhance Existing Ones
                    to Benefit Your Peers. Let's Improve Learning Together!
                ...
                <ul class="flex items-center space-x-3 mt-9">
                    ...
                    <li>
                        <a href="https://www.facebook.com/profile.php?id=61558568070149" title=""
                           class="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                            <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                 fill="currentColor">
                                <path
            ...
            <div class="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8 space-y-4">
                ...
                <p>Contribute to Our Question Bank: Share Your Questions!</p>

                <a href="{{ route('my-account.questions.create') }}" class="block">
                    <x-button.primary type="button" class=" px-4">Submit</x-button.primary>
                </a>
            </div>
        </div>
