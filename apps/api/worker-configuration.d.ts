/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8168dddaf6ad6b891972b81027a6e642)
...
interface __BaseEnv_Env {
	...
	JWT_SECRET: string;
	ADMIN_EMAIL: string;
	PDF_PROCESSOR_API_KEY: string;
	GEMINI_API_KEY: string;
	RECAPTCHA_SECRET_KEY: string;
	CF_ANALYTICS_API_TOKEN: string;
	CF_D1_API_TOKEN: string;
	R2_PUBLIC_BASE: string;
	AUTO_SUBMISSION_RATE_LIMITER: RateLimit;
	SUBMISSION_UPLOAD_RATE_LIMITER: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_CLIENT_ID" | "PDF_PROCESSOR_URL" | "WEB_ORIGINS" | "CF_ACCOUNT_ID" | "CF_D1_DATABASE_ID" | "JWT_SECRET" | "ADMIN_EMAIL" | "PDF_PROCESSOR_API_KEY" | "GEMINI_API_KEY" | "RECAPTCHA_SECRET_KEY" | "CF_ANALYTICS_API_TOKEN" | "CF_D1_API_TOKEN" | "R2_PUBLIC_BASE">> {}
}
