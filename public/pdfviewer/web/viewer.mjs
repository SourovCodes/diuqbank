...
const defaultOptions = {
  ...
  standardFontDataUrl: {
    value: "/pdfviewer/web/standard_fonts/",
    kind: OptionKind.API
  },
  verbosity: {
    value: 1,
  ...
  workerSrc: {
    value: "/pdfviewer/build/pdf.worker.mjs",
    kind: OptionKind.WORKER
  }
};
{
  defaultOptions.defaultUrl = {
    value: "/pdfviewer/web/compressed.tracemonkey-pldi-09.pdf",
    kind: OptionKind.VIEWER
  };
  defaultOptions.sandboxBundleSrc = {
    value: "/pdfviewer/build/pdf.sandbox.mjs",
    kind: OptionKind.VIEWER
  };
